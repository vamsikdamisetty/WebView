...
/*It is implementing the concept of webView : instead of going to the browser out
side the app to open the link , it loads the web page in your owns' apps webview*/
